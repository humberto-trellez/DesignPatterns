namespace DesignPatterns.DesignPatterns.Behavioral.Memento;
...
public class History
{
    ...
    public void ShowHistory()
    {
        ...
        foreach (var editorState in _states)
        {
            Console.WriteLine($"Title: {editorState.GetTitle()} - Content: {editorState.GetContent()}");
        }
    }
}